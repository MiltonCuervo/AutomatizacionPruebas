...
public class RegisterPage {
    ...
    public static final Target CHECKBOX_TERMS_AND_CONDITIONS = Target.the("Terms and conditions checkbox")
    ...
    public static final Target LBL_REGISTRATION_ERROR = Target.the("Registration error message")
